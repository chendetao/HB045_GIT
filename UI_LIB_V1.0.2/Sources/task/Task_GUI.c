...
//                NRF_GPIO_PIN_NOSENSE);	
    ...
    if ( events & TASK_GUI_FONT_ERASE_SECOTOR_EVT )
    {
        ...
        {
            osal_start_timerEx ( task_id, TASK_GUI_FONT_ERASE_SECOTOR_EVT, 50);
        }else
        {       
            ...
            osal_start_timerEx ( task_id, TASK_GUI_FONT_WRITE_PAGE_EVT, 50);
        }
    ...
    if ( events & TASK_GUI_FONT_WRITE_PAGE_EVT )
    {
        ...
        if ( write_Cur_page < write_All_page )
        {
            ...
            osal_start_timerEx ( task_id, TASK_GUI_FONT_WRITE_PAGE_EVT, 25);
        }else
        {
