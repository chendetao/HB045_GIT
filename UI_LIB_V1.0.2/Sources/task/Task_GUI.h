...
#define TASK_GUI_HR_DELAY_EVT            0x00040000
#define TASK_GUI_SYS_POWEROFF_EVT        0x00080000

#define TASK_GUI_FONT_ERASE_SECOTOR_EVT  0x00100000

#define TASK_GUI_FONT_WRITE_PAGE_EVT     0x00200000
#define TASK_GUI_FONT_READ_PAGE_EVT      0x00400000
#define TASK_GUI_FONI_INIT_EVT           0x00800000
#define TASK_GUI_FONT_WRITE_PAGE_1_EVT   0x01000000
#define TASK_GUI_FONT_DEBUG_EVT          0x02000000
