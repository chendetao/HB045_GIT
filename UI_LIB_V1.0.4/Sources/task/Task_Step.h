...
#define TASK_STEP_MONITOR_COMFIRM_EVT_1     0x01000000
#define TASK_STEP_UPLOAD_FAST_WAVE_EVT      0x02000000

#define TASK_STEP_TAKE_ENABLE_EVT           0x04000000
#define STEP_TASK_NOTIFY_SLEEP_TEST_EVT     0x08000000
#define TASK_STEP_SLEEP_STATISTICS_EVT      0x10000000
