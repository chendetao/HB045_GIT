...
#define TASK_STORE_SAVE_SW_EVT          0x00002000
#define TASK_UPLOAD_STORE_UIT_EVT       0x00001000
#define TASK_UPLOAD_STORE_UIT_2_EVT     0x00000800
#define TASK_UPLOAD_STORE_UIT_1_EVT     0x00000400
#define TASK_STORE_SAVE_UVT_EVT         0x00000200
