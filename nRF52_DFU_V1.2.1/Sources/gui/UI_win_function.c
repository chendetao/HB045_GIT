...
{	
//	window_cnt = window_counter();
//	
//	if ( window_cnt == 0 ){
//		/** A error occour */while(1) { __asm("WFI"); }
//	}else if ( window_cnt == 1 )
//	{
//        /** 
//		 * Just one window can be show
//		 */
//		int win_id = window_get(WIN_ID_FUNCTION+1);
//		if ( win_id < 3 ) {
//			/** A error occour */while(1) { __asm("WFI"); }
//		}else
//		{
//			DrawUI_Bitmap(8,48,64,64,BMP_function_array[win_id-WIN_ID_FUNCTION-1],BMP_FUNCTION_RUNNING_RGB_F,BMP_FUNCTION_RUNNING_RGB_B);
//		}
//	}else {
